...
pub use persona_card::{
    ...
    OwnerActionItem, OwnerAdvisorySummary, OwnerAgentLearningView, OwnerEvidenceManifestStatus,
    ...
    run_owner_historical_evidence_trial, run_walk_forward_evaluation, to_daily_candle_series,
