...
pub use acquisition::{
    ...
    AcquisitionReceipt, AcquisitionReceiptStatus, AgentCanonicalViewGapReportV1,
    AgentCanonicalViewGapV1, AgentDataIntent, AgentDataPolicy, AgentEvidenceBundle,
    AgentLearningDataViewV0, AgentLearningIndependenceProofV0, AgentLearningIntentV0,
    AgentPrivateLearningStateV0, AgentProposalEvidenceBinding, AutonomousDataCycleInput,
    AutonomousDataCyclePlan, AutonomousDataCycleResult, BrokerExecutionResult,
    CanonicalLearningArtifactEnvelopeV0, CanonicalViewGapStatusV1,
    CompositeLearningAcquisitionRegistrationV1, CompositeLearningAcquisitionResultV1,
    CompositeLearningEpochReceiptV1, CompositeLearningEpochStatusV1,
    CompositeLearningMergedProvenanceV1, ConfiguredUniverse, DataAcquisitionBroker, DataLookback,
    DataPriority, DataSnapshot, DatasetKind, EvidenceDecisionGate, EvidenceFreshnessStatus,
    FrozenSnapshotSet, InMemorySnapshotStore, LearningDataArtifactRefV0,
    LearningDataAuthorityActionV0, LearningDataCallerV0, LearningDataChairFirewallProofV0,
    LearningDataPlaneSafetyCountersV0, LearningDataProvenanceManifestV0,
    LearningDataUsageClassificationV0, LearningDataVisibilityV0,
    LearningEvidenceAcquisitionRegistrationV1, LearningEvidenceAcquisitionResultV1,
    LearningEvidenceArtifactWriteStatusV1, LearningEvidenceProviderContractV1,
    LearningEvidenceRequestReceiptV1, LearningEvidenceRequestStatusV1,
    LearningEvidenceSafetyCountersV1, LearningEvidenceSegmentCapsuleV1,
    LearningEvidenceSegmentReceiptV1, LearningEvidenceSegmentRegistrationV1,
    ...
    MockReadOnlyProvider, PERSISTED_LEARNING_INTENT_PROJECTION_VERSION_V1, ProviderCapabilities,
    ProviderFetchFailure, ReadOnlyMarketDataProvider, ReadOnlyProviderRegistry,
    ReadOnlyProviderRequest, ReadOnlyProviderResponse, RejectedAcquisitionRequest,
    SnapshotAdjustmentSemanticsV1, SnapshotCompatibilityV1, SnapshotProvenance,
    SnapshotQualitySummary, SnapshotSourceType, StaleDataPolicy,
    ...
    canonical_snapshot_semantic_digest_v1, composite_learning_expected_timestamps_v1,
    create_agent_learning_intent_v0, decode_agent_canonical_view_gap_report_protobuf_v1,
    decode_agent_learning_data_view_protobuf_v0,
    decode_composite_learning_registration_protobuf_v1,
    decode_learning_evidence_provenance_protobuf_v1, decode_learning_evidence_receipt_protobuf_v1,
    decode_learning_evidence_registration_protobuf_v1, default_agent_data_policies,
    derive_active_agent_learning_intents_v0, derive_agent_canonical_view_gaps_v1,
    derive_agent_private_learning_state_v0, encode_agent_canonical_view_gap_report_protobuf_v1,
    encode_agent_learning_data_view_protobuf_v0,
    encode_composite_learning_registration_protobuf_v1,
    encode_learning_evidence_provenance_protobuf_v1, encode_learning_evidence_receipt_protobuf_v1,
    encode_learning_evidence_registration_protobuf_v1, execute_autonomous_data_cycle,
    execute_composite_learning_acquisition_v1, execute_learning_evidence_acquisition_v1,
    ...
    read_and_verify_agent_learning_data_view_v0, read_composite_epoch_receipt_v1,
    read_composite_learning_registration_v1, read_learning_evidence_receipt_v1,
    read_learning_evidence_registration_v1, seal_learning_data_provenance_manifest_v0,
    seal_learning_evidence_provider_contract_v1,
    select_composite_learning_acquisition_registration_v1,
    select_learning_evidence_acquisition_registration_v1, snapshot_id_from_semantic_digest_v1,
    validate_agent_learning_data_view_v0, validate_agent_learning_intent_v0,
    validate_composite_learning_acquisition_registration_v1,
    validate_composite_learning_epoch_receipt_v1,
    validate_learning_evidence_acquisition_registration_v1,
    validate_learning_evidence_request_receipt_v1, validate_learning_evidence_segment_capsule_v1,
    validate_learning_evidence_segment_receipt_v1,
    write_and_verify_agent_canonical_view_gap_report_v1,
    write_and_verify_agent_learning_data_view_v0, write_and_verify_composite_epoch_receipt_v1,
    write_and_verify_composite_learning_registration_v1,
    write_and_verify_composite_merged_provenance_v1, write_and_verify_composite_segment_capsule_v1,
    write_and_verify_composite_segment_receipt_v1,
    write_and_verify_learning_evidence_provenance_v1,
    write_and_verify_learning_evidence_receipt_v1,
    write_and_verify_learning_evidence_registration_v1, write_and_verify_learning_raw_response_v1,
};
...
pub use upbit_historical_pilot::{
    ...
    fetch_upbit_learning_evidence_once_v1, inspect_upbit_duplicate_conflict_v0,
    merge_existing_upbit_snapshot_v0, merge_upbit_historical_pages_v0,
    migrate_legacy_json_snapshot_v0, parse_upbit_daily_ohlcv_v0, plan_btc_regime_backfill_v0,
    pre_register_prospective_public_export_acquisition_v0, preflight_upbit_historical_backfill_v0,
    prospective_outcome_request_fingerprint_v0, prospective_public_export_request_plan_v0,
    qualify_upbit_historical_provider_v0, read_local_snapshot_protobuf_v1,
    read_prospective_network_export_capsule_v0, read_prospective_outcome_acquisition_receipt_v0,
    read_prospective_outcome_evidence_capsule_v0,
    ...
    select_upbit_historical_provider_v0, upbit_learning_evidence_provider_contract_v1,
    validate_prospective_outcome_acquisition_plan_v0,
