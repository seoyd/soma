...
pub use acquisition::{
    ...
    CanonicalLearningArtifactEnvelopeV0, CanonicalViewGapStatusV1, ConfiguredUniverse,
    ...
    LearningEvidenceSafetyCountersV1, LearningEvidenceTransportFailureV1,
    LearningEvidenceTransportResponseV1, LearningNetworkPilotInputV0, LearningNetworkPilotPlanV0,
    LearningNetworkPilotStatusV0, MockReadOnlyProvider,
    PERSISTED_LEARNING_INTENT_PROJECTION_VERSION_V1, ProviderCapabilities, ProviderFetchFailure,
    ReadOnlyMarketDataProvider, ReadOnlyProviderRegistry, ReadOnlyProviderRequest,
    ReadOnlyProviderResponse, RejectedAcquisitionRequest, SnapshotAdjustmentSemanticsV1,
    SnapshotCompatibilityV1, SnapshotProvenance, SnapshotQualitySummary, SnapshotSourceType,
    StaleDataPolicy, agent_learning_independence_proof_v0, authorize_learning_data_action_v0,
    ...
    decode_agent_learning_data_view_protobuf_v0, decode_learning_evidence_provenance_protobuf_v1,
    ...
    encode_agent_learning_data_view_protobuf_v0, encode_learning_evidence_provenance_protobuf_v1,
    encode_learning_evidence_receipt_protobuf_v1,
    encode_learning_evidence_registration_protobuf_v1, execute_autonomous_data_cycle,
    execute_learning_evidence_acquisition_v1, freeze_decision_snapshot_set,
    historical_replay_dataset_digest_v0, learning_data_chair_firewall_proof_v0,
    migrate_legacy_learning_view_json_v0, plan_agent_data_intent, plan_autonomous_data_cycle,
    plan_learning_network_pilot_v0, read_and_verify_agent_learning_data_view_v0,
    read_learning_evidence_receipt_v1, read_learning_evidence_registration_v1,
    seal_learning_data_provenance_manifest_v0, seal_learning_evidence_provider_contract_v1,
    ...
    validate_learning_evidence_request_receipt_v1,
    write_and_verify_agent_canonical_view_gap_report_v1,
    write_and_verify_agent_learning_data_view_v0, write_and_verify_learning_evidence_provenance_v1,
