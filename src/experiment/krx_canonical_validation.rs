...
pub enum KRXCanonicalValidationStatus {
    Valid,
    MissingFile,
...
pub struct KRXCanonicalValidationReport {
    ...
    pub validation_status: KRXCanonicalValidationStatus,
    pub reason_codes: Vec<ReasonCode>,
}

impl KRXCanonicalValidationReport {
    pub fn validate(
        ...
        let mut report = Self {
            ...
            validation_status: KRXCanonicalValidationStatus::DiagnosticOnly,
        ...
        if !canonical_path.exists() {
            ...
            report.validation_status = KRXCanonicalValidationStatus::MissingFile;
        ...
        if !report.required_columns_present {
            ...
            report.validation_status = KRXCanonicalValidationStatus::MissingRequiredColumns;
            report.reason_codes = stable_reason_codes(&reason_codes);
            return report;
        }
        ...
        for line in lines.filter(|line| !line.trim().is_empty()) {
            ...
            if let Some(timestamp) = timestamp {
                ...
                report.validation_status = KRXCanonicalValidationStatus::BadTimestamp;
            }
