...
pub struct CycleRiskRegimeResultV0 {
    ...
    pub train_feature_end: usize,
    pub validation_feature_start: usize,
    pub validation_feature_end: usize,
    pub test_feature_start: usize,
...
fn run_regime(
    ...
    Ok(CycleRiskRegimeResultV0 {
        ...
        train_feature_end: raw_train_end,
        validation_feature_start: raw_train_end + gap,
        validation_feature_end: raw_validation_end,
        test_feature_start: raw_validation_end + gap,
        normalizer_digest: normalizer.digest.clone(),
        representation_normalizer_digest: representation_normalizer.digest.clone(),
        candidate_model_version_id: version_id.clone(),
